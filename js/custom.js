			...
			$("#jplayer_1").jPlayer({
				ready: function () {
					$(this).jPlayer("setMedia", {
						title:"Suzanna",
							artist:"Sauti_sol",
							mp3:"files/sauti_sol_suzanna.mp3"
					});
				},
			...
			[
				{
					...
					artist:"",
					album:"Gospel",
					mp3:"files/mojiGospel.mp3",
					poster:"images/gospel.jpg"
				},
				{
					title:"Rnb",
					artist:"",
					album:"Rnb",
					mp3:"files/justRnb.mp3",
				...
				},
				{
					...
					artist:"",
					album:"Bongo",
					mp3:"files/diaBongo.mp3",
					poster:"images/bongo.jpg"
				},
				{
					title:"Country",
					artist:"",
					album:"Country",
					mp3:"files/Country.mp3",
